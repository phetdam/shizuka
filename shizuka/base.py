...
class shizukaBaseCV(FrozenClass):
    ...
    .. note::
       ...
       :class:`shizukaBaseCV` subclass to "freeze" the class.
    ...
    def _raw__repr__(self):
        """Raw textual representation of the :class:`shizukaBaseCV`.

        Gives a string representation of a :class:`shizukaBaseCV` instance.
        Output is scikit-learn style, i.e.

        .. code:: python

           shizukaBaseCV(best_estimator=LogisticRegression, ...)
...
class shizukaCoreCV(shizukaBaseCV):
    ...
    .. note::
       ...
       class, but users should never need to create a :class:`shizukaBaseCV`
       instance themselves.
    ...
    :param cv_results: A dict of per-fold cross-validation results. Each key is
        ...
        ``resampled_shapes``
          ...
          th fold data shape is ``(n_res_samples_i, n_features)``. If 
    ...
    def __repr__(self):
        """Textual representation of the :class:`shizukaCoreCV` instance.
        ...
        .. code:: python
           ...
           shizukaCoreCV(best_estimator=Perceptron, best_params={'penalty': ...)
    ...
    def resampled_shapes(self):
        ...
        :returns: A list of :attr:`cv_iter` training data shapes after
            ...
            training data is ``(n_res_samples_i, n_features)``.
        :rtype: list
        """
...
class shizukaSearchCV(shizukaBaseCV):
    ...
    .. note::
       ...
       Users should not need to create :class:`shizukaSearchCV` instances
       themselves.
    ...
    :param cv_results: A dict with validation results for each model trained. If
        ...
        ``rank_cv_score``
          A list of model rankings, by mean cross-validation score.
